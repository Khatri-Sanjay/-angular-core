...
export class ProductListComponent {
  ...
  totalProductLength = this.products.length;
  totalNoOfProductInStock = this.products.filter(p => p.is_in_inventory).length;
  totalNoOfProductOutOFStock = this.products.filter(p => !p.is_in_inventory).length;
