...
export class StudentService{
    students: Student[] = [
        new Student(1, 'John Smith', 'Male', new Date('11-12-1997'), 'MBA', 520, 1899.01244231),
    ...
    filterStudentByGender(gender: string) {
        if (gender === undefined && false || gender.toLowerCase() === 'all' || this.students.length === 0) {
             return this.students;
        } else {
            return this.students.filter((value: any) => value.gender.toLowerCase() === gender.toLowerCase());
        }
    }
}
